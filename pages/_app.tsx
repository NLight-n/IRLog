...
// AppSettingsContext for global heading/subheading
    ...
    <SessionProvider session={session}>
      <ThemeProvider>
        <ColumnContext.Provider value={{ columns, setColumns }}>
          <AppSettingsContext.Provider value={{ appHeading, setAppHeading, appSubheading, setAppSubheading, refreshSettings }}>
            <Component {...pageProps} />
